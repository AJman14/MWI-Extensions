...
function toggleSkillPanel(){
    ...
    if (document.querySelector(ngicPanel)) {
        ...
        if (localStorage.getItem(character+'-ngicToggle') == 'checked'){
            ...
            } else if (localStorage.getItem(character+'-coicToggle') == 'checked' && (title.innerText == 'Cheesesmithing' || title.innerText == 'Crafting' || title.innerText == 'Tailoring' || title.innerText == 'Cooking' || title.innerText == 'Brewing' || title.innerText == 'Alchemy')){
                document.querySelector(ngicPanel).classList.add('ngicDisabledPanel');
